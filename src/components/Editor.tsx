...
export default function Editor() {
  ...
  const handleDeletePost = async () => {
    ...
    try {
      ...
      if (response.ok) {
        localStorage.removeItem('smooth_draft_content');
        localStorage.removeItem('smooth_draft_id');
  ...
  return (
    <div className="relative">
      ...
      <EditorToolbar editor={editor} fontSize={fontSize} setFontSize={setFontSize} onNewPost={handleNewPost} onDeletePost={handleDeletePost} />
    </div>
  );
}
