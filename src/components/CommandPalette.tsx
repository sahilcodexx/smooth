            ...
            >
              ...
              <div className="flex items-center px-4 border-b border-zinc-200 dark:border-zinc-800/50">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <kbd className="px-2 py-1 text-[10px] font-medium bg-zinc-100 dark:bg-zinc-800 text-zinc-500 rounded-md border border-zinc-200 dark:border-zinc-700">ESC</kbd>
                </div>
              </div>
              ...
              <div className="max-h-[60vh] overflow-y-auto p-2 scrollbar-none">
                ...
                {!query && (
                  <div className="mb-4">
                    <div className="px-3 py-1.5 text-xs font-semibold text-zinc-500">Quick Actions</div>
                    <a href="/create" className="flex items-center justify-between w-full px-3 py-3 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transition-colors group cursor-pointer text-left">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-zinc-700 dark:text-zinc-200">Create New Post</span>
                      </div>
                ...
                {filteredPosts.length > 0 ? (
                  <div>
                    <div className="px-3 py-1.5 text-xs font-semibold text-zinc-500">Your Posts</div>
                      ...
                      >
                        <div className="flex items-center gap-3 overflow-hidden">
                          ...
                          <div className="flex flex-col truncate">
                            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-200 truncate">{post.title || "Untitled Draft"}</span>
                          </div>
                        </div>
                      </a>
                    ))}
